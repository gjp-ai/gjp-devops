...
# Run the mysql_db_backup playbook against the inventory group 'ubuntu_server'.
# Usage: ./mysql_db_backup.sh
...
ansible-playbook ./playbook/mysql_db_backup.yml -i ~/.ansible/inventory/hosts -l ubuntu_server