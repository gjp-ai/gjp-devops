...
# Run the mysql_db_restore playbook against the inventory group 'ubuntu_server'.
# Usage: ./mysql_db_restore.sh
...
ansible-playbook ./playbook/mysql_db_restore.yml -i ~/.ansible/inventory/hosts -l ubuntu_server