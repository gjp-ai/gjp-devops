...
# Run the mysql_db_create playbook against the inventory group 'ubuntu_server'.
# Usage: ./mysql_db_create.sh
...
ansible-playbook ./playbook/mysql_db_create.yml -i ~/.ansible/inventory/hosts -l ubuntu_server