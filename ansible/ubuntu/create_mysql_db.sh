...
# Run the create_mysql_db playbook against the inventory group 'ubuntu_server'.
# Usage: ./create_mysql_db.sh
...
ansible-playbook ./playbook/create_mysql_db.yml -i ~/.ansible/inventory/hosts -l ubuntu_server
